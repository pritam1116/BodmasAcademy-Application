	...
	<!--  Admin Login  -->
	  ...
	  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		...
		<div class="modal-body customer-box">
				<!-- Nav tabs -->
				<ul class="nav nav-tabs">
					<li><a class="active" href="#Admin" data-toggle="tab">Login</a></li>
					...
					<div class="tab-pane active" id="Admin">
						...
						<input type="hidden" name="command" value="LOGIN" /> 
							<div class="form-group">
								<div class="col-sm-12">
									<input class="form-control" id="email1" placeholder="Email" type="email" name="email" required>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-12">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="#" data-toggle="modal" data-target="#admin">Admin</a></li>    
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>Bodmas</strong> Academy</h2>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-left">
									<div class="big-tagline">
										<h2 data-animation="animated zoomInRight">Bodmas<strong> Academy </strong></h2>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-center">
									<div class="big-tagline">
										<h2 data-animation="animated zoomInRight"><strong>Bodmas</strong> Academy</h2>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4>2018 BEST Bodmas Academy</h4>
                        <h2>Welcome to Bodmas Academy</h2>
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
							<div class="testi-meta">
                                <img src="images/rsz_munna_pic.png" alt="" class="img-fluid">
                                <h4>Munna Boss </h4>
                            </div>
                            <div class="desc">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i> Wonderful Support!</h3>
                                <p class="lead">Director of BODMAS ACADEMY:</p>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        <!-- end testimonial -->
